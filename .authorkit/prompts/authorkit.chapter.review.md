...
4. **Load review context**:
   ...
   - **Optional**: research.md and relevant `research/` topic files discovered recursively (scope `general` and `chapter CHNN`) for accuracy checks and claim verification
