...
5. **Stop and report**: Command ends after validation. Report OUTLINE path, generated artifacts (research.md, characters.md), and whether research/ topics (including nested folders) were consumed.
