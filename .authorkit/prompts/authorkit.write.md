...
- **Pass 2 — AI-Tic**: LLM tic budgets (per `.authorkit/prompts/_shared/literary-tic-catalog.md`) honored on the first pass, with explicit constitution waivers noted.
