# Author Kit - Copilot Instructions
...
4. **Outline** → Generate the full book outline with arcs and themes
5. **Chapters** → Break the outline into a chapter task list
6. **Chapter Plan → Draft → Review** → Iterate each chapter through plan/draft/review
7. **Analyze** → Cross-chapter consistency analysis
8. **Revise** → Apply targeted fixes
9. **Checklist** → Generate quality checklists
...
Use the prompt files in `.github/prompts/` to trigger structured workflows:
