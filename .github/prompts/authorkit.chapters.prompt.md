...
1. **Setup**: Run `.authorkit/scripts/powershell/check-prerequisites.ps1 -Json` from repo root and parse BOOK_DIR and AVAILABLE_DOCS list. All paths must be absolute.
...
4. **Generate chapters.md**: Use the chapters template (see #file:.authorkit/templates/chapters-template.md) as structure, fill with:
