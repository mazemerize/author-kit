...
2. **Parse chapter number** from user input:
   ...
   - If no chapter number provided: ERROR "Please specify a chapter number (e.g., provide '1' as input)"
...
7. **Generate chapter plan**: Load the chapter plan template (see #file:.authorkit/templates/chapter-plan-template.md) and fill it with:
...
11. **Report completion**:
   ...
   - Suggested next step: use the `authorkit.chapter.draft` prompt with the same chapter number
